...
const OPPONENT_SQUADS_2025_26 = {
  ...
  "Sunderland": [
    ...
    "Chemsdine Talbi", "Brian Brobbey", "Wilson Isidor", "Nilson Angulo", "Romaine Mundle", "Bertrand Traoré", "Simon Adingra", "Marc Guiu",
  ],
  "Tottenham Hotspur": [
    "Guglielmo Vicario", "Antonín Kinsky", "Brandon Austin",
    "Radu Dragusin", "Kevin Danso", "Destiny Udogie", "Cristian Romero", "Pedro Porro", "Ben Davies", "Micky van de Ven", "Djed Spence", "Souza", "Junai Byfield",
    "João Palhinha", "Xavi Simons", "Yves Bissouma", "James Maddison", "Archie Gray", "Lucas Bergvall", "Dejan Kulusevski", "Conor Gallagher", "Pape Sarr", "Rodrigo Bentancur", "Callum Olusesi",
    "Richarlison", "Mathys Tel", "Dominic Solanke", "Mohammed Kudus", "Wilson Odobert", "Randal Kolo Muani", "James Wilson",
  ],
  "Aston Villa": [
